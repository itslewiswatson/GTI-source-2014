...
-- Date: 26 Feb 2014
-- Resource: GTImapMods/mapMods.lua
-- Type: Client Side
...
function loadMapMods()
	...
	-- Andromada Mod
	txd = engineLoadTXD("vehicles/androm.txd")
	engineImportTXD(txd, 592)
	dff = engineLoadDFF("vehicles/androm.dff")
	...
	col8 = engineLoadCOL('objects/lsmall_shop01.col')
	dff8 = engineLoadDFF('objects/lsmall_shop01.dff', 0)
	txd8 = engineLoadTXD('objects/lsmall_shops.txd')
