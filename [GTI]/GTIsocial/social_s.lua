...
hiddenCMDS = {
	["nick"]=true, ["restart"]=true, ["refresh"]=true,
	["start"]=true, ["stop"]=true, ["refreshall"]=true,
	["gti"]=true, ["admin"]=true, ["debugscript"]=true,
	["Previous"]=true, ["Next"]=true, ["Reload"]=true,
	}

noshowCMDS = { ["toggle"]=true, ["Toggle"]=true, ["say"]=true, ["teamsay"]=true,
	["local"]=true,
}

chatCMDS = { ["say"]=true, ["teamsay"]=true, ["local"]=true,
	["me"]=true,
}
devCMDS = { ["restart"]=true, ["refresh"]=true, ["refreshall"]=true, ["start"]=true, ["stop"]=true, ["debugscript"]=true}

adminCMDS = { ["chgpass"]=true, ["admin"]=true, ["ban"]=true,
	["slap"]=true, ["mute"]=true, ["kick"]=true, ["freeze"]=true
}
	...
	function( command)
		...
		elseif noshowCMDS[command] then
			...
			elseif adminCMDS[command] then
				...
				logSocialMessage( name, "You executed the command '"..command.."'", "brief", 5, "Briefing", "Command", "player", "purple")
			end
		end
	end
)
