...
-- Login GUI
------------->>
login = {checkbox = {},edit = {},button = {},window = {},label = {}}
...
-- Buttons
login.button[1] = guiCreateButton(155, 160, 74, 24, "Register", false, login.window[1])
login.button[2] = guiCreateButton(74, 160, 74, 24, "Login", false, login.window[1])
login.button[3] = guiCreateButton(236, 160, 74, 24, "Cancel", false, login.window[1])
-- Other
...
guiEditSetMaxLength(register.edit[1], 25)
...
guiEditSetMaxLength(register.edit[3], 25)
...
guiEditSetMaxLength(register.edit[4], 25)
-- Buttons
